#!/bin/bash -l
#SBATCH --job-name=rossice_final_working
...
#SBATCH --output=/scratch/project_462000640/ammar/rossice/logs/final_working_%j.out
#SBATCH --error=/scratch/project_462000640/ammar/rossice/logs/final_working_%j.err

echo "🎯 === ROSSICE FINAL - ENTRAÎNEMENT COMPLET ==="
echo "Date: $(date)"
echo "Node: $(hostname)"
...
echo ""
echo "=== 🚀 ENTRAÎNEMENT ROSSICE CORRIGÉ ==="
cat > rossice_final_working.py << 'EOF'
#!/usr/bin/env python3
"""
...
echo ""
echo "🚀 === LANCEMENT DE L'ENTRAÎNEMENT FINAL ==="
python rossice_final_working.py

echo ""
echo "=== 🎯 RÉSUMÉ FINAL ==="
echo "Date: $(date)"
echo "✅ Configuration GPU validée"
echo "✅ Dataset CAQRA fonctionnel"  
echo "✅ Forward ClimaX corrigé"
echo "✅ Entraînement Lightning complet"
echo ""
echo "🏁 FIN DE L'ENTRAÎNEMENT ROSSICE"